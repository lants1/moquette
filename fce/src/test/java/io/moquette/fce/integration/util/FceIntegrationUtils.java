 ...
 */
package io.moquette.fce.integration.util;
 ...
 */
public class FceIntegrationUtils {
    public static String localMapDBPath() {
    ...
    public static Properties prepareTestPropeties() {
        ...
        testProperties.put(PERSISTENT_STORE_PROPERTY_NAME, FceIntegrationUtils.localMapDBPath());
