...
public class MqttManageHandler extends FceEventHandler implements IFceMqttCallback {
	...
	public void messageArrived(String topicIdentifier, MqttMessage message) throws Exception {
		...
		case CONFIG_PRIVATE:
		case CONFIG_GLOBAL:
			loadConfiguration(topicIdentifier, zone, msgPayload, topic);
			break;
		case QUOTA_PRIVATE:
		case QUOTA_GLOBAL:
			loadQuota(topicIdentifier, zone, msgPayload, topic);
			break;
		default:
			break;
		}
	...
	private void loadQuota(String topicIdentifier, ManagedZone zone, String msgPayload, ManagedTopic topic)
	...
	private void loadConfiguration(String topicIdentifier, ManagedZone zone, String msgPayload, ManagedTopic topic) {
